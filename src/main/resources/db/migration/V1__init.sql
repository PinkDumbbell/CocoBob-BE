...
(
    ...
    productDetailImage varchar(1000) null,
    description text null,
    protein float null,
    amountOfProteinPerMcal double null,
    fat float null,
    amountOfFatPerMcal double null,
    fiber float null,
    amountOfFiberPerMcal double null,
    mineral float null,
    amountOfMineralPerMcal double null,
    calcium float null,
    amountOfCalciumPerMcal double null,
    phosphorus float null,
    amountOfPhosphorusPerMcal double null,
    moisture float null,
    kcalPerKg double null,
    isAAFCOSatisfied boolean null,
    beef boolean null,
    mutton boolean null,
